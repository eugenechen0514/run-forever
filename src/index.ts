...
export function forever<INIT_V = undefined>(fn: ForeverExecutionFunction<INIT_V>, previousValue: (INIT_V | undefined) = undefined, callback: ForeverCallback<INIT_V> = () => {}): void {
